...
public class frmInternalShtoVetura extends JInternalFrame {
	...
	public frmInternalShtoVetura() {
		...
		if (Gjuha.gjuha == "albanian") {
			...
			panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Identification Details", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		}
		...
		if (Gjuha.gjuha == "albanian") {
			rbAutomatik.setText("Automatik");
		} else {
			rbAutomatik.setText("Automatic:");
		}
		...
		if (Gjuha.gjuha == "albanian") {
			lblNderruesiIShpejtesise.setText("Nderruesi i Shpejtesise:");
		} else {
			lblNderruesiIShpejtesise.setText("Gear Changer:");
		}
		...
		if (Gjuha.gjuha == "albanian") {
			...
			lblKarburanti.setText("Carburant:");
		}
		...
		if (Gjuha.gjuha == "albanian") {
			lblShpenzimetLkm.setText("Shpenzimet: (L/100km)");
		} else {
			lblShpenzimetLkm.setText("Cost: (L/100km):");
		}
		...
		if (Gjuha.gjuha == "albanian") {
			nrUleseve.setText("Numri i Uleseve:");
		} else {
			nrUleseve.setText("Seats:");
		}
		...
		JCheckBox cbNafte = new JCheckBox();
		if (Gjuha.gjuha == "albanian") {
			cbNafte.setText("Naft\u00EB");
		} else {
			cbNafte.setText("Disel");
		}
		...
		if (Gjuha.gjuha == "albanian") {
			cbBenzine.setText("Benzin\u00EB");
		} else {
			cbBenzine.setText("Gasoline");
		}
		...
		if (Gjuha.gjuha == "albanian") {
			cbElektrik.setText("Elektrik");
		} else {
			cbElektrik.setText("Electric");
		}
		...
		if (Gjuha.gjuha == "albanian") {
			btnShtoAutomjetin.setText("Shto Automjetin");
		} else {
			btnShtoAutomjetin.setText("Add Car");
		}
		btnShtoAutomjetin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				{
					JOptionPane.showMessageDialog(null, "Sadri!");
				}
