...
public class frmInternalKategoriteKostot extends JInternalFrame {
	...
	public frmInternalKategoriteKostot() {
		...
		if (Gjuha.gjuha == "albanian") {
			lblFormaPrMenaxhimin.setText("FORMA P\u00CBR MENAXHIMIN KATEGORIVE DHE KOSTOVE");
		} else {
			lblFormaPrMenaxhimin.setText("Forms of management categories and costs");
		}
		lblFormaPrMenaxhimin.setFont(new Font("Tahoma", Font.PLAIN, 17));
		lblFormaPrMenaxhimin.setBounds(10, 11, 615, 26);
		...
		JLabel lblKategoria = new JLabel();
		 if (Gjuha.gjuha == "albanian") {
		...
		JLabel lblKostojaJavore = new JLabel();
		if (Gjuha.gjuha == "albanian") {
			lblKostojaJavore.setText("Kostoja Javore:");
		} else {
			lblKostojaJavore.setText("Weekly Cost:");
		}
		...
		JLabel lblKostojaDitore = new JLabel();
		if (Gjuha.gjuha == "albanian") {
			lblKostojaDitore.setText("Kostoja Ditore:");
		} else {
			lblKostojaDitore.setText("Daily Cost:");
		}
		...
		JLabel lblKostojaMujore = new JLabel();
		if (Gjuha.gjuha == "albanian") {
			lblKostojaMujore.setText("Kostoja Mujore:");
		} else {
			lblKostojaMujore.setText("Monthly Cost");
		}
		...
		JButton btnNdrysho = new JButton();
		if (Gjuha.gjuha == "albanian") {
		...
		JButton btnShtoTre = new JButton();
		if (Gjuha.gjuha == "albanian") {
			btnShtoTre.setText("Shto T'Re");
		} else {
			btnShtoTre.setText("Add New");
		}
