...
public class frmInternalListaVeturave extends JInternalFrame {
	...
	public frmInternalListaVeturave() {
		...
		cmbKarburanti.setModel(new DefaultComboBoxModel(new String[] {"Dizell", "Benzin"}));
		...
		JLabel lblVitiProdhimit = new JLabel("Nderruesi:");
		if (Gjuha.gjuha == "albanian") {
			lblVitiProdhimit.setText("Reacher:");
		} else {
			lblVitiProdhimit.setText("Model");
		}
		lblVitiProdhimit.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblVitiProdhimit.setBounds(10, 346, 74, 14);
		...
		JLabel lblVitiProdhimit_1 = new JLabel("Viti Prodhimit:");
		if (Gjuha.gjuha == "albanian") {
			lblVitiProdhimit_1.setText("Viti Prodhimit:");
		} else {
			lblVitiProdhimit_1.setText("Production Year:");
		}
		lblVitiProdhimit_1.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblVitiProdhimit_1.setBounds(271, 256, 91, 14);
		getContentPane().add(lblVitiProdhimit_1);
		...
		if (Gjuha.gjuha == "albanian") {
			...
			lblNrUleseve.setText("No. of Sides:");
		}
		lblNrUleseve.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblNrUleseve.setBounds(271, 286, 91, 14);
		getContentPane().add(lblNrUleseve);
		
		JLabel lblKarburanti = new JLabel("Shpenzimet:");
		if (Gjuha.gjuha == "albanian") {
			lblKarburanti.setText("Shpenzimet:");
		} else {
			lblKarburanti.setText("Expenses");
		}
		lblKarburanti.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblKarburanti.setBounds(271, 319, 91, 14);
		...
		JLabel lblKarburanti_1 = new JLabel("Karburanti:");
		if (Gjuha.gjuha == "albanian") {
			lblKarburanti_1.setText("Karburanti");
		} else {
			lblKarburanti_1.setText("Fuel");
		}
		lblKarburanti_1.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblKarburanti_1.setBounds(10, 375, 74, 14);
		getContentPane().add(lblKarburanti_1);
