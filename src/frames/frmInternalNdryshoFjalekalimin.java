		...
		btnNdryshoFjalkalimin.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if( pwdFjalkRi.getText().equals("") || pwdKonFjalk.getText().equals("") ) {
					JOptionPane.showMessageDialog(null, "Ju lutëm plotësoni të gjitha fushat e zbrazëta!");
				} 
				else if ( !pwdFjalkRi.getText().equals(pwdKonFjalk.getText()) ) {
					JOptionPane.showMessageDialog(null, "Fjalëkalimin e ri nuk është njejtë në të dy fushat!");
				}
				else if ( pwdFjalkAktual.getText().equals("") ) {
					JOptionPane.showMessageDialog(null, "Ju lutem shenoni fjalëkalimin aktual për të verifikuar ndërrimin e fjalëkalimit!");
				}
					...
					JOptionPane.showMessageDialog(null, "Fjalëkalimin për verifikim është shënuar gabim!");
				}
